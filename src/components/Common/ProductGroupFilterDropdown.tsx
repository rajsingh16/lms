...
import { ProductGroupFilterOptions } from '../../types/product';

interface ProductGroupFilterDropdownProps {
  onFilter: (filters: ProductGroupFilterOptions) => void;
  businessPartners: string[];
}

export const ProductGroupFilterDropdown: React.FC<ProductGroupFilterDropdownProps> = ({
  onFilter,
  businessPartners
}) => {
  const [isOpen, setIsOpen] = useState(false);
  const [filters, setFilters] = useState<ProductGroupFilterOptions>({});
  ...
  const handleFilterChange = (key: keyof ProductGroupFilterOptions, value: string) => {
