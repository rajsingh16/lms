...
import { DistrictFilterOptions } from '../../types/product';

interface DistrictFilterDropdownProps {
  onFilter: (filters: DistrictFilterOptions) => void;
}

export const DistrictFilterDropdown: React.FC<DistrictFilterDropdownProps> = ({
  onFilter
}) => {
  const [isOpen, setIsOpen] = useState(false);
  const [filters, setFilters] = useState<DistrictFilterOptions>({});
  ...
  const handleFilterChange = (key: keyof DistrictFilterOptions, value: string) => {
